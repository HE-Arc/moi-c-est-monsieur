...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <div class="score">
        ...
        <div class="card">
                <p class="event_desc"><?php echo e($attack_ripost[0]->attack); ?></p>
            </div>

        <div id="cards" class="cards">
			<?php $__currentLoopData = $attack_ripost[1]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ripost): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="card" onclick="validate(<?php echo e($ripost->id); ?>)">
                <p class="event_desc"><?php echo e($ripost->ripost); ?></p>
            </div>
        ...
        <div class="modal-header">
            ...
            <h2><?php echo e($category[0]->nom); ?></h2>
        </div>
        <div class="modal-body">
            <p>Ouille !</p>
            <p><?php echo e($category[0]->sermon); ?></p>
        </div>
        </div>
    ...
    <script src="<?php echo e(asset('public/js/popup.js')); ?>"></script>
</html>
<?php /**PATH C:\wamp64\www\moi-c-est-monsieur\resources\views/game.blade.php ENDPATH**/ ?>